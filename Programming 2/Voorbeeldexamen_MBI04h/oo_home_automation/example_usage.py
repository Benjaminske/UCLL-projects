...
print(f"Lamp energy consumption: {lamp.energy_consumption}")
...
print(f"Heating energy consumption: {heating.energy_consumption}")
...
# Heating energy consumption: 2000
...
print(f"WashingMachine energy consumption: {washer.energy_consumption}")
...
# WashingMachine energy consumption: 1500
